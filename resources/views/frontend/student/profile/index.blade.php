            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8 wow fadeInRight">
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{route('profile.update', ['role' => 'student'])}}"  enctype="multipart/form-data" method="post" class="wsus__dashboard_profile_update">
                            @csrf
                            @method('patch')
                            <div class="row">
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{route('profile.password-update', 'student')}}" method="post" class="wsus__dashboard_profile_update">
                            @csrf
                            @method('patch')
                            <div class="row">
                                <div class="col-xl-6">
