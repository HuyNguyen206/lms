<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
    <div class="add_course_basic_info">
        <form method="post" action="{{route('instructor.courses.store', \App\Models\Course::BASIC_INFO)}}"
                ...
                <div class="col-xl-6">
                    <div class="add_course_basic_info_imput">
                        ...
                        <select class="select_2" id="select_source" name="demo_video_storage">
                            ...
                            <option
                                @selected(old('demo_video_storage') === \App\Enums\VideoStorageType::UPLOAD->value) value="{{\App\Enums\VideoStorageType::UPLOAD->value}}">
                                Upload
                            </option>
                            <option
                                @selected(old('demo_video_storage') === \App\Enums\VideoStorageType::YOUTUBE->value) value="{{\App\Enums\VideoStorageType::YOUTUBE->value}}">
                                Youtube
                            </option>
                            <option
                                @selected(old('demo_video_storage') === \App\Enums\VideoStorageType::VIMEO->value) value="{{\App\Enums\VideoStorageType::VIMEO->value}}">
                                Vimeo
                            </option>
                            <option
                                @selected(old('demo_video_storage') === \App\Enums\VideoStorageType::EXTERNAL_LINK->value) value="{{\App\Enums\VideoStorageType::EXTERNAL_LINK->value}}">
                                External link
                            </option>
                        </select>
                    </div>
...
{{--                                <input class="form-control" type="text" name="demo_video_url">--}}
                                <input id="thumbnail" class="form-control" type="text" name="filepath">

                            </div>
                            <div id="holder" style="margin-top:15px;max-height:100px; width: 100px"></div>
                        </div>
                    </div>

                    {{--                        <input type="text" name="demo_video_url" id="source_file">--}}
